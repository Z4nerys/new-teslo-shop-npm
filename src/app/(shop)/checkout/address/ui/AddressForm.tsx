    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("firstName", { required: true })}
                />
            </div>
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("lastName", { required: true })}
                />
            </div>
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("address", { required: true })}
                />
            </div>
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("address2")}
                />
            </div>
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("postalCode", { required: true })}
                />
            </div>
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("city", { required: true })}
                />
            </div>
            ...
            <div className="flex flex-col mb-2">
                <span>País</span>
                <select
                    className="p-2 border rounded-md bg-gray-300" {...register("country", { required: true })}
                >
            ...
            <div className="flex flex-col mb-2">
                ...
                <input
                    type="text"
                    className="p-2 border rounded-md bg-gray-300" {...register("phone", { required: true })}
                />
            </div>
